...
class ReplayManager:
    ...
    def create_replay_from_task(self, source_task_id, trigger_task_id):
        ...
        self.memory.record_task(new_id, new_goal, workspace_path=str(new_workspace))
        self.memory.update_task_metadata(new_id, {"task_type": "replay", "parent_task_id": source_task_id})

        return {"new_task_id": new_id, "workspace_path": str(new_workspace)}
